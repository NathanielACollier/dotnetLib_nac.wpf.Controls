...
public class OpenFolderDialog : IDisposable
{
    ...
    /// WPF Compatibility
    /// </summary>
    /// <param name="wpfVisual">Use this, or a wpf window/control something like that</param>
    /// <returns></returns>
    public DialogResult ShowDialog(Visual wpfVisual)
    {
        return ShowDialog(nac.wpf.Controls.WPFWindowsFormsCompatibilityExtensions.GetIWin32Window(wpfVisual));
    }
    ...
    private DialogResult ShowLegacyDialog(IWin32Window owner)
    {
        using (var frm = new SaveFileDialog())
        {
            ...
            {
                this.Folder = System.IO.Path.GetDirectoryName(frm.FileName);
                return DialogResult.OK;
            }
            else
            {
